  ...
  addData(int intervalNumber) {
    ...
    for (int dayNumber = 0; dayNumber < Days.values.length; dayNumber++) {
      day = DayTableModel(
        ...
        typeInterval1: secondBox.get(keyOfStorage(dayNumber, 0),
            defaultValue: intervalTypes.last),
        typeInterval2: secondBox.get(keyOfStorage(dayNumber, 1),
            defaultValue: intervalTypes.last),
        typeInterval3: secondBox.get(keyOfStorage(dayNumber, 2),
            defaultValue: intervalTypes.last),
        typeInterval4: secondBox.get(keyOfStorage(dayNumber, 3),
            defaultValue: intervalTypes.last),
      );
      tableBox.put(dayNumber, day);
    }
